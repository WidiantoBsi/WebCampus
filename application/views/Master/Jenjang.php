    ...
    <div class="col-lg-12">
      <div class="card mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          ...
          <a href="#" class="m-0 float-right btn btn-success btn-sm" data-toggle="modal" data-target="#AddJenjang"><i class="fas fa fa-plus"></i> Add Jenjang</a>
        </div>
          ...
          <table class="table align-items-center table-flush" id="dataTable">
            ...
            <tbody>
              ...
              foreach($Jenjang as $b){
                ...
                ?>
                <tr>
                  <td><a href="#" title="Edit Data" data-toggle="modal" data-target="#modal_edit<?php echo $IdData;?>"><?php echo $b->ID_Jenjang ?></a></td>
                  <td><?php echo $b->NamaJenjang ?></td>
                  <td>
...
<!-- ============== Modal Add Dosen ====================== -->
<div class="modal fade" id="AddJenjang" tabindex="-1" role="dialog"
aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
<form action="<?php echo base_url('Master/').'AddJenjang'; ?>" method="post">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="myModalLabel">Add Jenjang</h3>
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      </div>
      <div class="modal-body">

        <div class="form-group">
          <label for="exampleFormControlInput1">Kode Jenjang</label>
  ...
  <div class="modal animated shake" id="modal_delete<?php echo $Kode; ?>">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content" style="margin-top:100px;">
        ...
        <form action="<?php echo base_url('Master').'/HapusJenjang'; ?>" method="post">
         <div class="modal-body">
