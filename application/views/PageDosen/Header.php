...
<body id="page-top">
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item <?php if($this->uri->segment(1)=="AdmDosen"){echo "active";}?>">
        <a class="nav-link" href="<?php echo base_url('AdmDosen')?>">
          <i class="fas fa-fw fa-calendar" title="Jadwal Dosen"></i>
          <span>Jadwal</span>
        </a>
      </li>
      <li class="nav-item <?php if($this->uri->segment(1)=="AddNilai"){echo "active";}?>">
        <a class="nav-link" href="<?php echo base_url('AddNilai')?>">
          <i class="fas fa-fw fa-book" title="Data Nilai"></i>
          <span>Nilai</span>
        </a>
      </li>
